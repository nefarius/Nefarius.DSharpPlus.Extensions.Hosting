...
/// </summary>
[Generator]
public class DiscordServiceIntentsBuilderGenerator : IIncrementalGenerator
{
                ...
                foreach (EnumMemberDeclarationSyntax intent in intents)
                {
                    ...
                    foreach (SyntaxNode summaryElement in summaryElements)
                    {
                        ...
                        foreach (SyntaxNode crefElement in crefElements)
                        {
                            ...
                            string eventName = crefAttribute.ChildNodes()
                                .Single(node => node.IsKind(SyntaxKind.QualifiedCref))
                                .ToString();
